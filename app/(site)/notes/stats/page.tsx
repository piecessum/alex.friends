  ...
  return (
    <main className="w-full flex-1 px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          <div className="h-[60vh] min-h-[420px] overflow-hidden rounded-2xl border border-neutral-200 bg-white/40 backdrop-blur lg:col-span-2 dark:border-neutral-700 dark:bg-[#181818]/40">
