...
export function PostGraph({
  ...
  return (
    <>
      ...
      <div className="fixed top-24 right-6 z-40 hidden h-44 w-60 overflow-hidden rounded-2xl border border-neutral-200/70 bg-white/60 shadow-lg shadow-black/5 backdrop-blur-md dark:border-neutral-700/70 dark:bg-[#181818]/50 lg:block">
        <div className="relative h-full w-full">
          ...
          <button
            ...
            className="absolute top-2 right-2 z-10 inline-flex h-8 w-8 items-center justify-center rounded-lg border border-neutral-200/70 bg-white/70 text-neutral-500 backdrop-blur transition hover:text-indigo-600 dark:border-neutral-700/70 dark:bg-[#181818]/60 dark:text-neutral-400 dark:hover:text-indigo-400"
          >
